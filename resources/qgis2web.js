...
map.getView().fit([8374447.380753, 1069366.039106, 8681694.617724, 1301841.544783], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BHARATHAPUZHA WEB</h2>';
        return titleElement;
    })(),
